...
// export type PreparedVideoStatisticsResponse = Record<string, number>;
...
export const Statistics = () => {
    ...
    const fetchStats = useCallback(async () => {
        ...
        try {
            const response = await fetchGet<Record<string, number>>({
                route: FetchRoutes2.getPreparedVideosStatisticsByDays,
                query: {days},
                isProd,
            });
    ...
    return (
        <div style={{padding: 20, maxWidth: 900, margin: '0 auto'}}>
            <h2>Prepared Videos Statistics</h2>
            <div style={{marginBottom: 16, display: 'flex', gap: 8}}>
                ...
                <Button view="outlined" href="/prepared-videos">
                    Back
                </Button>
            </div>
